...
# 燃动夏季
10 8,10,12,14,16 * * * node /scripts/jd_summer_movement_card.js >> /scripts/logs/jd_summer_movement_card.log 2>&1
# 燃动夏季
12 0-23/2 * * * node /scripts/jd_summer_movement_help.js >> /scripts/logs/jd_summer_movement_help.log 2>&1
#来客有礼小程序 送豆得豆
